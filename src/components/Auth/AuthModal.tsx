            ...
            {isModalOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 bg-slate-900/60 z-[1000] backdrop-blur-sm"
                    />
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 md:top-1/2 md:left-1/2 md:bottom-auto md:-translate-x-1/2 md:-translate-y-1/2 z-[1001] bg-white w-full md:w-[460px] rounded-t-[32px] md:rounded-[32px] p-6 pt-4 md:p-10 shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar pb-10"
                    >
                        {/* Drag Handle */}
                        ...
                        <form onSubmit={isVerifying ? handleVerifyOTP : (mode === 'login' ? handleLogin : handleRegister)} className="flex flex-col gap-4">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold hover:bg-blue-700 transition-all active:scale-[0.98] shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2 mt-2"
                                disabled={isLoading}
                            >
                                {isLoading ? (
                        ...
                        <div className="relative py-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="bg-white px-4 text-slate-400 font-medium">Yoki</span>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <button
                                ...
                                className="flex items-center justify-center gap-2 py-3 px-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors bg-white shadow-sm"
                            >
