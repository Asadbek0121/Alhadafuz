...
export async function generateMetadata({
    ...
    return translatedPageMetadata("courierScan", { locale, path: "/courier/scan", noindex: true });
}

export default function CourierScanLayout({ children }: { children: React.ReactNode }) {
    return <>{children}</>;
}
