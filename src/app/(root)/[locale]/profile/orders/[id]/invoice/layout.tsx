...
export async function generateMetadata({
    ...
    return translatedPageMetadata("profileInvoice", { locale, path: "/profile/orders", noindex: true });
}

export default function ProfileInvoiceLayout({ children }: { children: React.ReactNode }) {
    return <>{children}</>;
}
