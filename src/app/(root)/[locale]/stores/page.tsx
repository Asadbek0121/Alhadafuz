    ...
    return (
        <div className="bg-slate-50 min-h-screen pb-20">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-700 py-16 text-center text-white shadow-lg relative overflow-hidden">
                ...
                <h1 className="text-3xl md:text-5xl font-bold relative z-10">Bizning do'konlar</h1>
                <p className="text-emerald-100 mt-3 text-lg font-light relative z-10">Sizga eng yaqin filialni toping</p>
            </div>
            ...
            <div className="container max-w-6xl -mt-10 relative z-10 px-4">
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-emerald-50 min-h-[500px]">
                    ...
                    <div className="text-center mb-12">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">HADAF Surxondaryoda</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Bizning markaziy do'konimiz Termiz shahrida joylashgan. Yaqin kelajakda viloyatning barcha tumanlarida o'z filiallarimizni ochishni rejalashtirganmiz.
                        </p>
                    </div>
                        ...
                        <>
                            {stores.length > 0 ? (
                                    ...
                                    {stores.map((store) => (
                                        <div key={store.id} className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
                                            <div className="flex items-center justify-between mb-6">
                                                ...
                                                <span className="bg-emerald-100 text-emerald-800 text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wider">Ochiq</span>
                                            </div>
                                            ...
                                            <div className="space-y-4 text-gray-600">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <span className="text-sm font-medium">{store.phone || "Telefon mavjud emas"}</span>
                                                </div>
                                                <div className="flex items-center gap-4">
                                ...
                                <div className="text-center py-16 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900">Filiallar ro'yxati yangilanmoqda</h3>
                                    <p className="text-gray-500 mt-2">Hozirda tizimda faol do'konlar mavjud emas.</p>
                                </div>
                            )}
                        </>
                    )}
                    ...
                    <div className="mt-20 border-t border-gray-100 pt-12">
                        <h3 className="text-xl font-bold text-center text-gray-900 mb-8">Tez kunda ochiladigan manzillar</h3>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                            {['Denov', 'Sherobod', 'Boysun', 'Jarqo\'rg\'on'].map((city, idx) => (
                                <div key={idx} className="bg-gray-50 p-4 rounded-xl border border-gray-200 opacity-60">
                                    ...
                                    <span className="block text-xs text-gray-400 mt-1">Tez kunda</span>
                                </div>
                            ))}
                        </div>
                    </div>
