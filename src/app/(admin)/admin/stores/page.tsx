    ...
    return (
        <div className="p-5 space-y-4 bg-gray-50/50 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                ...
                >
                    <h1 className="text-xl font-extrabold tracking-tight text-gray-900">Do'konlar Tarmoqlari</h1>
                    <p className="text-gray-500 mt-0.5 text-sm">Filiallar va do'konlar joylashuvini boshqaring</p>
                </motion.div>
                <Button
                    onClick={() => { setShowForm(!showForm); if (!showForm) handleCreate(); }}
                    className="bg-blue-600 hover:bg-blue-700 text-white gap-2 rounded-lg shadow-md shadow-blue-100 transition-all active:scale-95 px-4 h-10"
                >
                    ...
                    >
                        <h2 className="text-lg font-black text-gray-900 mb-4 flex items-center gap-2">
                            <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600">
                                {editStore ? <Edit2 size={16} /> : <Plus size={16} />}
                            </div>
                        ...
                        <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium resize-none"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-4 focus:ring-blue-500/10 outline-none transition-all font-bold text-sm"
                            ...
                            <div className="space-y-4">
                                <div className="bg-blue-50/30 p-4 rounded-2xl border border-blue-100/50 space-y-4 relative overflow-hidden group/gps">
                                    ...
                                    <div
                                        className="relative h-64 rounded-2xl overflow-hidden border-4 border-white shadow-xl cursor-pointer group/map transition-all hover:shadow-2xl hover:scale-[1.01]"
                                    >
                                ...
                                <div className="flex gap-3 pt-4">
                                    <Button
                                        type="submit"
                                        disabled={saving}
                                        className="flex-1 bg-blue-600 hover:bg-blue-700 text-white h-10 rounded-xl shadow-md shadow-blue-200 font-bold active:scale-95 transition-all"
                                    >
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col min-h-[400px]">
                <div className="p-4 border-b border-gray-50 bg-gray-50/30 flex flex-col lg:flex-row justify-between items-center gap-3">
                    <div className="flex items-center gap-4 w-full lg:w-auto">
                        <div className="relative flex-1 lg:w-80">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-9 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-sm font-medium shadow-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center bg-white p-1 rounded-xl border border-gray-200 shadow-sm">
                        <button
                            ...
                            className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-blue-50 text-blue-600 shadow-inner' : 'text-gray-400 hover:text-gray-600'}`}
                        >
                            <LayoutGrid size={16} />
                        </button>
                        <button
                            onClick={() => setViewMode('list')}
                            className={`p-2 rounded-lg transition-all ${viewMode === 'list' ? 'bg-blue-50 text-blue-600 shadow-inner' : 'text-gray-400 hover:text-gray-600'}`}
                        >
                            <ListIcon size={16} />
                        </button>
                    </div>
                    ...
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-20 space-y-3">
                            <div className="relative">
                                <div className="w-12 h-12 rounded-full border-4 border-blue-50 animate-spin border-t-blue-500" />
                        ...
                        <div className={viewMode === 'grid' ? "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4" : "space-y-3"}>
                            {filteredStores.map((store, index) => (
                                <motion.div
                                    ...
                                    className={`group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-gray-200/50 transition-all ${viewMode === 'list' ? 'flex items-center p-4 gap-4' : 'flex flex-col'}`}
                                >
                                    <div className="p-4 flex-1 flex flex-col space-y-4 relative">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="bg-[#E8F5E9] text-[#2E7D32] text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest">
                                                OCHIQ
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-3 flex-1">
                                            <div className="flex items-center justify-between gap-3">
                                                <h3 className="text-lg font-black text-gray-900 tracking-tight truncate">{store.name}</h3>
                                        ...
                                        <div className="pt-1">
                                            {store.lat && store.lng ? (
                                                <a
                                                    ...
                                                    className="w-full bg-[#F5F7F9] hover:bg-blue-600 hover:text-white text-gray-900 font-bold py-2.5 rounded-xl flex items-center justify-center gap-2 group/btn transition-all no-underline shadow-sm hover:shadow-md hover:shadow-blue-200 cursor-pointer relative z-10"
                                                >
                                                    <Navigation size={16} className="text-gray-500 group-hover/btn:text-white transition-colors" />
                                                    <span className="text-[13px]">Xaritada ko'rish</span>
                                                </a>
                                            ) : (
                                                <div className="w-full bg-gray-50 text-gray-400 font-bold py-2.5 rounded-xl flex items-center justify-center gap-2 opacity-60">
                                                    <Navigation size={16} />
                                                    <span className="text-[13px]">Manzil aniqlanmagan</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-16 space-y-4 text-center">
                            <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center text-gray-300">
                                <Search size={24} />
                            </div>
                            <div className="space-y-1">
                                <p className="text-lg font-black text-gray-900">Do'kon topilmadi</p>
                ...
                {showMapModal && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white rounded-2xl w-full max-w-4xl h-[90vh] overflow-hidden flex flex-col relative"
                        >
                            <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-white z-[110]">
                                <div>
                                    <h3 className="text-lg font-black text-gray-900 flex items-center gap-2">
                                        <MapPin className="text-blue-600" size={18} /> Manzilni tanlang
                                    </h3>
                                    <p className="text-[11px] text-gray-500 font-bold uppercase tracking-wider">Xarita ustiga bosing yoki qidiring</p>
                                </div>
                                <div className="flex items-center gap-3 flex-1 max-w-md mx-8">
                                    <div className="relative flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 outline-none transition-all font-bold text-sm"
                                        />
                                    </div>
                                    <button
                                        onClick={handleSearchLocation}
                                        className="bg-blue-600 text-white px-4 py-2.5 rounded-xl font-black uppercase tracking-widest text-[10px] shadow-md shadow-blue-200 active:scale-95 transition-all flex items-center gap-2"
                                        aria-label="Qidirish"
                                    >
                                        Qidirish
                                    </button>
                            ...
                            <div className="relative flex-1 bg-gray-100">
                                ...
                                <div className="absolute top-8 right-8 z-[110] flex flex-col gap-3">
                                    <button
                                        onClick={handleGetCurrentLocation}
                                        className="w-10 h-10 bg-white hover:bg-blue-50 text-blue-600 rounded-xl shadow-lg flex items-center justify-center transition-all active:scale-95 group border border-blue-100"
                                ...
                                <div className="absolute bottom-5 right-5 z-[110] bg-white/95 backdrop-blur-xl p-4 rounded-2xl border border-white shadow-xl shadow-blue-900/10 space-y-3 w-64">
                                    ...
                                    <button
                                        onClick={() => setShowMapModal(false)}
                                        className="w-full bg-blue-600 hover:bg-blue-700 rounded-xl h-10 font-black text-white text-sm active:scale-95 transition-all shadow-md shadow-blue-100"
